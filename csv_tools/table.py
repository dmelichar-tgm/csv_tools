...
"""
*************************************
A Python implementation of a DB Table
*************************************

This module is a basic implementation of a Database Table,
or rather, it creates basic methods for one. Separated
into Table and Column for easier usage.
...
from csv_tools import CSVToolsReader, CSVToolsWriter
from csv_tools import sniffer
from csv_tools import typeinference
from csv_tools.cli import parse_column_identifiers
