...
"""
*************************
Type Inference Controller
*************************

It basically manages the difference implementation
of different languages of the same type (e.g. TEXT and String)
...
from csv_tools.exceptions import InvalidValueForTypeException, InvalidValueForTypeListException
